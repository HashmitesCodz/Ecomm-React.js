 ...
 const init = productId => {
     getProduct(productId).then(data=>{
         if(data.error){
            ...
            // populate the state
            setValues({...Layout, name: data.name,
...
formData: data.FormData()
 ...
 const clickSubmit = (event)=>{
        ...
        <form className="mb-3" onSubmit={clickSubmit}>
            ...
            <div className="form-group">
                <label className="btn btn-warning">
                    <input onChange={handleChange('photo')} name="photo" type="file" accept="image/*" required/>
                </label>
            </div>
            <div className="form-group">
    ...
    return(
        ...
        <Layout title="Create Product" description= {`G'Day ${user.name}! You can create a new product here.`}>
           <div className="row">
